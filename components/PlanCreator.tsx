...
export default function PlanCreator({ onClose }: Props) {
  ...
  async function handleGenerate() {
    ...
    try {
      setStatus('Gerando plano com IA (pode levar ~30-60s)...');
        ...
        <div className="px-6 py-5 border-b border-zinc-800/80">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Personalizado com IA para seus objetivos</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-5 flex flex-col gap-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Ex: Foque em AWS Solutions Architect. / Para minha irmã estudar pro ENEM, priorize matemática..."
              rows={3}
